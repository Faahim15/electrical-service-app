// src/app/quote/ev-charger/panel-location.tsx
...
export default function PanelLocation() {
  ...
  const { panelLocation, panelDistance } = useSelector(
      ...
      >
        ...
        >
          ...
          <OptionGrid
            ...
            onSelect={(val) => dispatch(setPanelLocation(val as any))}
            numColumns={1}
          />
          ...
          <View className="mb-2">
            <OptionGrid
              ...
              onSelect={(val) => dispatch(setPanelDistance(val as any))}
              numColumns={1}
            />
